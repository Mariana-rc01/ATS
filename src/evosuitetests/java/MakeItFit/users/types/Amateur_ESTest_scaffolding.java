...
public class Amateur_ESTest_scaffolding {
    ...
    public static void initEvoSuiteFramework() {
        org.evosuite.runtime.RuntimeSettings.className = "MakeItFit.users.types.Amateur";
    ...
    private static void initializeClasses() {
        org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(
            Amateur_ESTest_scaffolding.class.getClassLoader(),
