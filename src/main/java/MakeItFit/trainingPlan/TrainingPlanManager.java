...
public class TrainingPlanManager implements Serializable {
     ...
     */
    public TrainingPlan createTrainingPlan(UUID userCode, MakeItFitDate startDate)
     ...
     */
    public TrainingPlan constructTrainingPlanByObjectives(TrainingPlan trainingPlan,
                                                          float        index,
                                                          boolean      hardActivities,
        ...
        if (maxActivitiesPerDay < 0 || maxActivitiesPerDay > 3 || maxDifferentActivities < 0 ||
            weeklyRecurrence < 0 || weeklyRecurrence > 7 || minimumCaloricWaste < 0) {
        ...
        while (totalCaloricWaste < minimumCaloricWaste) {
            ...
            while (differentActivityTypes.size() == maxDifferentActivities &&
                   !differentActivityTypes.contains(activityType)) {
            ...
            switch (activityType) {
                case "PushUp": {
                    ...
                    activity             = new PushUp(trainingPlan.getUserCode(),
                                          currentDate,
                                          expectedDuration,
                ...
                case "Running": {
                    ...
                    activity                = new Running(trainingPlan.getUserCode(),
                                           currentDate,
                                           expectedDuration,
                ...
                case "Trail": {
                    ...
                    activity             = new Trail(trainingPlan.getUserCode(),
                                         currentDate,
                                         expectedDuration,
                ...
                case "WeightSquat": {
                    ...
                    activity                = new WeightSquat(trainingPlan.getUserCode(),
                                               currentDate,
                                               expectedDuration,
            ...
            if (activitiesAddedToday < maxActivitiesPerDay &&
                daysWithActivitiesThisWeek < weeklyRecurrence) {
    ...
    public void updateTrainingPlan(TrainingPlan trainingPlan) throws EntityDoesNotExistException {
        ...
        if (!this.trainingPlans.containsKey(code)) {
            throw new EntityDoesNotExistException("Training Plan with code " + code +
                                                  " does not exist.");
        }
