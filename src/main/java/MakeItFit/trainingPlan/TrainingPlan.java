...
public class TrainingPlan implements Serializable, Comparable<TrainingPlan> {
    ...
    public boolean equals(Object o) {
        ...
        return this.userCode.equals(trainingPlan.getUserCode()) &&
            this.startDate.equals(trainingPlan.getStartDate()) &&
            this.activities.equals(trainingPlan.getActivities());
    }
     ...
     * @return a negative integer, zero, or a positive integer as this training plan is less than,
     *     equal to, or greater than the other training plan
     */
    @Override
