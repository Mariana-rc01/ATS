...
/**
 * The WeightSquat class represents an activity of performing squats with weights as part of a
 * fitness routine. It extends the RepetitionsWithWeights class to include specific functionality
 * related to squats with weights.
 *
...
public class WeightSquat extends RepetitionsWithWeights implements Serializable {
     ...
     */
    public WeightSquat(UUID          userCode,
    ...
    /**
     * Calculates the caloric waste for the WeightSquat activity based on the repetitions, series,
     * and weight.
     *
     * @param index The index to be used in the calculation.
     * @return The total caloric waste calculated based on the number of repetitions, series, and
     *     weight.
     */
     ...
     * @return True if the object is an instance of WeightSquat and all attributes match; otherwise,
     *     false.
     */
    @Override
