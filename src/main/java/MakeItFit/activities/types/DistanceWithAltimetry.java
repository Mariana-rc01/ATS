...
public abstract class DistanceWithAltimetry extends Distance implements Serializable {
     ...
     */
    public DistanceWithAltimetry(UUID          userCode,
    ...
    /**
     * Constructs a new DistanceWithAltimetry instance as a copy of another DistanceWithAltimetry
     * instance.
     *
     ...
     * @return true if the object is an instance of DistanceWithAltimetry and all attributes match;
     *     otherwise, false
     */
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof DistanceWithAltimetry))
            return false;
        DistanceWithAltimetry d = (DistanceWithAltimetry) o;
        return (super.equals(d) && this.elevationGain == d.elevationGain &&
                this.elevationLoss == d.elevationLoss);
    }
    ...
    public String toString() {
        return super.toString() + "Elevation Gain: " + this.elevationGain + " meters, "
            + "Elevation Loss: " + this.elevationLoss + " meters, ";
    }
}
