...
public abstract class Repetitions extends Activity implements Serializable {
     ...
     */
    public Repetitions(UUID          userCode,
     ...
     * @return true if the object is a Repetitions instance and is equal to this instance; false
     *     otherwise
     */
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof Repetitions))
            return false;
    ...
    public String toString() {
        return super.toString() + "Repetitions: " + this.repetitions + ", "
            + "Series: " + this.series + ", ";
    }
}
