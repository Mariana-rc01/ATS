...
public abstract class RepetitionsWithWeights extends Repetitions implements Serializable {
     ...
     */
    public RepetitionsWithWeights(UUID          userCode,
    ...
    /**
     * Constructs a new RepetitionsWithWeights instance as a copy of another RepetitionsWithWeights
     * instance.
     *
     ...
     * @return true if the object is an instance of RepetitionsWithWeights and all attributes match;
     *     otherwise, false
     */
    public boolean equals(Object o) {
        if (o == this)
            return true;
        if (!(o instanceof RepetitionsWithWeights))
            return false;
