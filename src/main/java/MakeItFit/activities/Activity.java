...
public abstract class Activity implements ActivityInterface, Serializable, Comparable<Activity> {
    ...
    public boolean equals(Object o) {
        ...
        return (this.expectedDuration == a.expectedDuration &&
                this.designation.equals(a.designation));
    }
    ...
    /**
     * Compares the activity to another activity based on the realization date and expected
     * duration.
     *
     * @param other the other activity to compare
     * @return a negative integer, zero, or a positive integer as this activity is less than, equal
     *     to, or greater than the other activity
     */
    @Override
