...
public class MakeItFitDate implements Comparable<MakeItFitDate>, Serializable {
    ...
    /**
     * Determines whether this MakeItFitDate instance is before or the same as another MakeItFitDate
     * instance.
     *
     * @param date the MakeItFitDate instance to compare with
     * @return true if this MakeItFitDate instance is before or the same as the other MakeItFitDate
     ...
     *
     * @param date the MakeItFitDate instance to compare with
     * @return true if this MakeItFitDate instance is before the other MakeItFitDate instance;
     *     otherwise, false
     */
    ...
    /**
     * Determines whether this MakeItFitDate instance is after or the same as another MakeItFitDate
     * instance.
     *
     * @param date the MakeItFitDate instance to compare with
     * @return true if this MakeItFitDate instance is after or the same as the other MakeItFitDate
     *     instance; otherwise, false
     */
     ...
     *
     * @param date the MakeItFitDate instance to compare with
     * @return true if this MakeItFitDate instance is after the other MakeItFitDate instance;
     *     otherwise, false
     */
     ...
     * @return a negative integer, zero, or a positive integer as this MakeItFitDate instance is
     *     before, the same as, or after the other MakeItFitDate instance
     */
    @Override
