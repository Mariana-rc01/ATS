...
public class MakeItFit implements Serializable {
    ...
    public void createUser(String name,
                           ...
                           int    frequency,
                           String type)
        throws IllegalArgumentException, ExistingEntityConflictException, InvalidTypeException {
     ...
     */
    public UUID createTrainingPlan(UUID userCode, MakeItFitDate startDate)
        throws IllegalArgumentException {
        TrainingPlan trainingPlan =
            this.trainingPlanManager.createTrainingPlan(userCode, startDate);
     ...
     * @throws IllegalArgumentException If the provided arguments are not valid.
     */
    public void constructTrainingPlanByObjectives(TrainingPlan trainingPlan,
                                                  boolean      hardActivity,
                                                  int          maxActivitiesPerDay,
                                                  int          maxDifferentActivities,
                                                  int          weeklyRecurrence,
                                                  int          minimumCaloricWaste)
        throws IllegalArgumentException {
        this.trainingPlanManager.constructTrainingPlanByObjectives(
            trainingPlan,
            this.userManager.getUserByCode(trainingPlan.getUserCode()).getIndex(),
            hardActivity,
            maxActivitiesPerDay,
    ...
    public void updateSystem(MakeItFitDate currentDate, UUID userCode) {
        ...
        this.trainingPlanManager.updateActivities(currentDate,
                                                  userManager.getUserByCode(userCode).getIndex());
        List<Activity> activities =
            this.trainingPlanManager.extractActivities(currentDate, userCode);
     ...
     */
    public double
        executeQueryHowManyKMsDone(String email, MakeItFitDate date1, MakeItFitDate date2) {
        return this.queriesManager.executeQueryHowManyKMsDone(this.userManager,
                                                              email,
                                                              date1,
                                                              date2);
    }
     ...
     */
    public double
        executeQueryHowManyAltimetryDone(String email, MakeItFitDate date1, MakeItFitDate date2) {
        return this.queriesManager.executeQueryHowManyAltimetryDone(this.userManager,
                                                                    email,
                                                                    date1,
                                                                    date2);
    }
    ...
    public TrainingPlan executeQueryMostDemandingTrainingPlan() {
        return this.queriesManager.executeQueryMostDemandingTrainingPlan(this.trainingPlanManager,
                                                                         this.userManager);
    }
