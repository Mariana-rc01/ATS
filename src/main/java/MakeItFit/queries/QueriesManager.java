...
public class QueriesManager implements Serializable {
     ...
     */
    public double executeQueryHowManyAltimetryDone(UserManager   userManager,
                                                   String        email,
                                                   MakeItFitDate date1,
                                                   MakeItFitDate date2) {
     ...
     */
    public double executeQueryHowManyKMsDone(UserManager   userManager,
                                             String        email,
                                             MakeItFitDate date1,
                                             MakeItFitDate date2) {
     ...
     */
    public TrainingPlan
        executeQueryMostDemandingTrainingPlan(TrainingPlanManager trainingPlanManager,
