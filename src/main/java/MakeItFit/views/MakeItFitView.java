...
public abstract class MakeItFitView {
    ...
    public void createUser() throws InvalidTypeException {
        ...
        try {
            ...
            do {
                System.out.print(
                    "[APP] Please enter the type of user (Amateur | Occasional | Professional): ");
                userType = scanner.nextLine();
            } while (!userType.equals("Amateur") && !userType.equals("Occasional") &&
                     !userType.equals("Professional"));
    ...
    private void updateName() {
        ...
        try {
            System.out.print("[" + this.makeItFitController.getName() +
    ...
    private void updateGender() {
        ...
        try {
            System.out.print("[" + this.makeItFitController.getName() +
                             "] Please enter the gender (Male | Female | Other): ");
            Gender gender = Gender.valueOf(scanner.next());
    ...
    public void addActivityToUser() {
        ...
        try {
            ...
            do {
                System.out.print(
                    "[" + this.makeItFitController.getName() +
                    "] Please select the activity (PushUp | WeightSquat | Running | Trail): ");
                activityType = scanner.nextLine();
            } while (!activityType.equals("PushUp") && !activityType.equals("WeightSquat") &&
                     !activityType.equals("Running") && !activityType.equals("Trail"));
            ...
            try {
                ...
                switch (this.activityType) {
                    case "PushUp" -> {
                        ...
                        this.makeItFitController.addActivityToUser(date,
                                                                   duration,
                                                                   designation,
                                                                   this.activityType,
                                                                   repetitions,
            ...
            System.out.println("[" + this.makeItFitController.getName() +
                               "] Activity added to user successfully.");
        } catch (Exception e) {
            System.out.println("[" + this.makeItFitController.getName() + "] Invalid input.");
        }
    }
    ...
    public void removeActivityFromUser() {
        System.out.println("[" + this.makeItFitController.getName() +
                           "] Removing activity from user ...");

        Scanner scanner = new Scanner(System.in);

        try {
            System.out.print("[" + this.makeItFitController.getName() +
                             "] Please insert the code of the activity: ");
    ...
    public void createTrainingPlan() {
        ...
        try {
            System.out.print("[" + this.makeItFitController.getName() +
                             "] Please enter the start date (dd/mm/aaaa): ");
    ...
    public void constructTrainingPlan() {
        System.out.println("[" + this.makeItFitController.getName() +
                           "] Constructing training plan ...");

        try {
            addActivityToTrainingPlan();

            System.out.println("[" + this.makeItFitController.getName() +
                               "] Training plan constructed successfully.");
        } catch (Exception e) {
            System.out.println("[" + this.makeItFitController.getName() + "] Invalid input.");
        }
    }
    ...
    public void addActivityToTrainingPlan() {
        System.out.println("[" + this.makeItFitController.getName() +
                           "] Adding activity to training plan ...");

        Scanner scanner = new Scanner(System.in);

        try {
            System.out.print("[" + this.makeItFitController.getName() +
                             "] Please enter the number of iterations for the activity: ");
            ...
            try {
                ...
                switch (this.activityType) {
                    case "PushUp" -> {
                        ...
                        this.makeItFitController.addActivityToTrainingPlan(date,
                                                                           duration,
                                                                           designation,
                                                                           this.activityType,
                                                                           repetitions,
            ...
            System.out.println("[" + this.makeItFitController.getName() +
                               "] Activity added to training plan successfully.");
        } catch (Exception e) {
            System.out.println("[" + this.makeItFitController.getName() + "] Invalid input.");
        }
    }
    ...
    public void generateTrainingPlan() {
        ...
        try {
            System.out.print("[" + this.makeItFitController.getName() +
                             "] Do you want to add hard activities? (y/n): ");
            ...
            while (maxActivitiesPerDay > 3) {
                System.out.print(
                    "[" + this.makeItFitController.getName() +
                    "] Please insert the maximum number of activities per day (max 3): ");
                maxActivitiesPerDay = scanner.nextInt();
            }
            scanner.nextLine(); // Consume the remaining newline

            System.out.print("[" + this.makeItFitController.getName() +
                             "] Please insert the maximum number of different activities: ");
            ...
            while (maxWeeklyRecurrence > 7) {
                System.out.print("[" + this.makeItFitController.getName() +
                                 "] Please insert the weekly recurrence expected (max 7): ");
            ...
            while (minCalories < 1) {
                System.out.print("[" + this.makeItFitController.getName() +
                                 "] Please insert the minimum number of calories to be consumed: ");
                minCalories = scanner.nextInt();
            }
            scanner.nextLine(); // Consume the remaining newline

            this.makeItFitController.constructTrainingPlanByObjectives(hardActivities,
                                                                       maxActivitiesPerDay,
    ...
    public void removeActivityFromTrainingPlan() {
        System.out.println("[" + this.makeItFitController.getName() +
                           "] Removing activity from training plan ...");
    ...
    public void removeTrainingPlan() {
        System.out.println("[" + this.makeItFitController.getName() +
                           "] Removing training plan ...");

        Scanner scanner = new Scanner(System.in);

        try {
            System.out.print("[" + this.makeItFitController.getName() +
                             "] Please insert the code of the training plan: ");
            UUID code = UUID.fromString(scanner.nextLine());
    ...
    public void selectTrainingPlan() throws RuntimeException {
        ...
        try {
            ...
            this.makeItFitController.setTrainingPlan(code);
            System.out.println("[" + this.makeItFitController.getName() +
                               "] Training plan selected successfully.");
        } catch (Exception e) {
            System.out.println("[" + this.makeItFitController.getName() + "] Invalid input.");
