...
public class UserManager implements Serializable {
    ...
    public User createUser(String name,
                           ...
                           String email,
                           int    frequency,
                           String type) throws IllegalArgumentException, InvalidTypeException {
    ...
    public void insertUser(User user) throws ExistingEntityConflictException {
        ...
        if (this.usersByEmail.containsKey(email)) {
            throw new ExistingEntityConflictException("User with email " + email +
                                                      " already exists.");
        }
