...
public class MakeItFitController {
     ...
     */
    public void addActivityToUser(MakeItFitDate date,
                                  int           duration,
                                  String        designation,
                                  String        name,
                                  int           repetitions,
    ...
    public void addActivityToUser(MakeItFitDate date,
                                  ...
                                  double        distance,
                                  double        speed) {
        Running activity = new Running(this.makeItFit.getUser(email).getCode(),
                                       date,
                                       duration,
                                       designation,
                                       name,
    ...
    public void addActivityToUser(MakeItFitDate date,
                                  ...
                                  int           trailType) {
        Trail activity = new Trail(this.makeItFit.getUser(email).getCode(),
                                   date,
                                   duration,
                                   designation,
                                   name,
    ...
    public void addActivityToUser(MakeItFitDate date,
                                  ...
                                  int           series,
                                  double        weight) {
        WeightSquat activity = new WeightSquat(this.makeItFit.getUser(email).getCode(),
                                               date,
                                               duration,
                                               designation,
                                               name,
     ...
     */
    public void constructTrainingPlanByObjectives(boolean hardActivity,
                                                  int     maxActivitiesPerDay,
                                                  int     maxDifferentActivities,
                                                  int     weeklyRecurrence,
                                                  int     minimumCaloricWaste)
        throws IllegalArgumentException {
        this.makeItFit.constructTrainingPlanByObjectives(
            this.makeItFit.getTrainingPlan(this.trainingPlan),
            hardActivity,
            maxActivitiesPerDay,
     ...
     */
    public void addActivityToTrainingPlan(MakeItFitDate date,
                                          int           duration,
                                          String        designation,
                                          String        name,
                                          int           repetitions,
    ...
    public void addActivityToTrainingPlan(MakeItFitDate date,
                                          ...
                                          double        weight,
                                          int           iterations) {
        WeightSquat activity = new WeightSquat(this.makeItFit.getUser(this.email).getCode(),
                                               date,
                                               duration,
                                               designation,
                                               name,
