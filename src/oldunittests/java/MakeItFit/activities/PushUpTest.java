...
public class PushUpTest {
    ...
    public void testConstructors() {
        ...
        PushUp pushUp1 =
            new PushUp(UUID, MakeItFitDate.of(2024, 4, 4), 40, "Daily try", "PushUp", 10, 4);
    ...
    public void testPushUpConstructors() {
        UUID   UUID = java.util.UUID.randomUUID();
        PushUp pushUp1 =
            new PushUp(UUID, MakeItFitDate.of(2024, 4, 4), 30, "Daily try", "PushUp", 10, 10);
    ...
    public void testCalculateCaloricWaste() {
        User   user           = new Amateur("John",
                                ...
                                "974632836",
                                "jonh@mail.com");
        PushUp pushUp1        = new PushUp(user.getCode(),
        ...
        assertEquals(expectedWaste1,
                     pushUp1.getCaloricWaste(),
                     "Caloric waste should match the expected value.");

        PushUp pushUp2        = new PushUp(user.getCode(),
                                    MakeItFitDate.of(2024, 4, 4),
                                    30,
                                    "Daily try",
                                    "PushUp",
        ...
        assertEquals(expectedWaste2,
                     pushUp2.getCaloricWaste(),
                     "Caloric waste should match the expected value.");
    }
    ...
    public void testPushUpEquals() {
        ...
        PushUp pushUp2 = new PushUp(user.getCode(),
                                    ...
                                    6,
                                    4);
        assertEquals(pushUp1,
                     pushUp2,
                     "PushUp instances with the same properties should be equal.");
    }
}
