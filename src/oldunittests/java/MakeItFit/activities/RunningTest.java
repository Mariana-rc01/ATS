 ...
 *
 * These tests verify the functionality of the Running class, which represents a running activity in
 * the application.
 *
...
public class RunningTest {
    ...
    public void testConstructors() {
        User    user = new Amateur("John",
                                ...
                                "974632836",
                                "jonh@mail.com");
        Running run1 = new Running(user.getCode(),
    ...
    public void testEquals() {
        ...
        Running run1 = new Running(user1.getCode(),
                                   MakeItFitDate.of(2024, 4, 4),
                                   45,
                                   "Braga em Movimento",
                                   "Running",
                                   2300,
                                   14.5);
        Running run2 = new Running(user2.getCode(),
                                   MakeItFitDate.of(2024, 4, 4),
                                   45,
                                   "Braga em Movimento",
                                   "Running",
