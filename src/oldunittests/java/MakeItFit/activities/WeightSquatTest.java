...
public class WeightSquatTest {
    ...
    public void testConstructors() {
        User        user   = new Amateur("John",
                                ...
                                "974632836",
                                "jonh@mail.com");
        WeightSquat squat1 = new WeightSquat(user.getCode(),
    ...
    public void testCalculateCaloricWaste() {
        ...
        assertEquals(6968,
                     squat1.getCaloricWaste(),
                     "Calculated caloric waste should match the expected value.");
    }
    ...
    public void testEquals() {
        ...
        WeightSquat squat2 = new WeightSquat(user.getCode(),
                                             MakeItFitDate.of(2024, 4, 4),
                                             30,
                                             "Weekly try",
                                             "WeightSquat",
        ...
        assertEquals(squat1,
                     squat2,
                     "WeightSquat instances with identical parameters should be considered equal.");
    }
}
