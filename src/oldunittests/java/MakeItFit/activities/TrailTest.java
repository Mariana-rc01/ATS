...
public class TrailTest {
    ...
    public void testConstructors() {
        ...
        assertEquals(trail2.getTrailType(),
                     Trail.TRAIL_TYPE_MEDIUM,
                     "Trail type should match the original");
    }
    ...
    public void testGetTrailType() {
        User  user   = new Professional("John",
                                     20,
                                     Gender.Male,
                                     70,
                                     180,
        ...
        Trail trail1 = new Trail(user.getCode(),
                                 ...
                                 200.3,
                                 Trail.TRAIL_TYPE_MEDIUM);
        assertEquals(trail1.getTrailType(),
                     Trail.TRAIL_TYPE_MEDIUM,
                     "The trail type should be medium");
    }
    ...
    public void testEquals() {
        ...
        Trail trail1 = new Trail(user.getCode(),
                                 ...
                                 200.3,
                                 Trail.TRAIL_TYPE_EASY);
        Trail trail2 = new Trail(user.getCode(),
                                 MakeItFitDate.of(2024, 4, 4),
                                 40,
                                 "Serra da Estrela",
                                 "Trail",
