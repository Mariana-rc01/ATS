...
public class OccasionalTest {
    ...
    public void testParameterizedConstructor() {
        Occasional user1 = new Occasional("José Fernandes",
                                          45,
                                          Gender.Male,
                                          75,
                                          175,
        ...
        assertEquals("josefernandes@mail.com",
                     user1.getEmail(),
                     "The email should match the input");
    }
    ...
    public void testCopyConstructor() {
        ...
        assertEquals(user1.getFrequency(),
                     user2.getFrequency(),
                     "The frequency should be equal to the original");
        ...
        assertEquals(user1.getGender(),
                     user2.getGender(),
                     "The gender should be equal to the original");
        assertEquals(user1.getWeight(),
                     user2.getWeight(),
                     "The weight should be equal to the original");
        assertEquals(user1.getHeight(),
                     user2.getHeight(),
                     "The height should be equal to the original");
        assertEquals(user1.getBpm(), user2.getBpm(), "The BPM should be equal to the original");
        assertEquals(user1.getLevel(),
                     user2.getLevel(),
                     "The level should be equal to the original");
        assertEquals(user1.getAddress(),
                     user2.getAddress(),
                     "The address should be equal to the original");
        assertEquals(user1.getPhone(),
                     user2.getPhone(),
                     "The phone number should be equal to the original");
        assertEquals(user1.getEmail(),
                     user2.getEmail(),
                     "The email should be equal to the original");
    }
