...
public class UserManagerTest {
    ...
    public void testCreateUserValidInputs() {
        UserManager userManager = new UserManager();
        User        user        = userManager.createUser("José Fernandes",
                                           45,
                                           Gender.Male,
                                           75,
                                           175,
    ...
    public void testCreateUserInvalidInputs() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            userManager.createUser("José Fernandes",
                                   -1,
                                   Gender.Male,
                                   75,
                                   175,
    ...
    public void testInsertUserDuplicateEmail() {
        UserManager userManager = new UserManager();
        User        user1       = userManager.createUser("José Fernandes",
                                            45,
                                            Gender.Male,
                                            75,
                                            175,
        ...
        User user2 = userManager.createUser("António Silva",
                                            25,
                                            Gender.Male,
                                            95,
                                            198,
    ...
    public void testUpdateNonExistingUser() {
        ...
        User        user        = userManager.createUser("José Fernandes",
                                           ...
                                           7,
                                           "Professional");
        assertThrows(EntityDoesNotExistException.class, () -> { userManager.updateUser(user); });
    }
