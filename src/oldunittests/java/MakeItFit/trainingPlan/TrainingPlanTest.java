 ...
 *
 * This class contains tests for the constructors, methods, and operations of the TrainingPlan
 * class, including tests for construction, object equality, and getters.
 *
...
public class TrainingPlanTest {
    ...
    public void testTrainingPlanConstructors() {
        ...
        assertEquals(trainingPlan1,
                     trainingPlan2,
                     "Copy constructor should create an equal instance.");
    }
    ...
    public void testTrainingPlanGetters() {
        ...
        assertEquals(UUID_user,
                     trainingPlan.getUserCode(),
                     "User code should match the expected value.");
        assertEquals(startDate,
                     trainingPlan.getStartDate(),
                     "Start date should match the expected value.");
    }
    ...
    public void testTrainingPlanAddActivity() {
        ...
        TrainingPlan  trainingPlan = new TrainingPlan(UUID_user, startDate);
        assertEquals(0,
                     trainingPlan.getActivities().size(),
                     "The activities list should be empty.");

        trainingPlan.addActivity(10, null);
        assertEquals(1,
                     trainingPlan.getActivities().size(),
                     "The activities list should have one element.");
    }
    ...
    public void testTrainingPlanRemoveActivity() {
        ...
        PushUp pushUp = new PushUp(UUID.randomUUID(),
    ...
    public void testTrainingPlanEquals() {
        ...
        assertTrue(
            trainingPlan1.equals(trainingPlan2),
