 ...
 * MostDemaningTrainingPlan class,
 *
...
public class MostDemaningTrainingPlanTest {
    ...
    void setUp() {
        ...
        testUser.addActivity(new Running(testUser.getCode(),
        ...
        TrainingPlan trainingPlan1 =
            new TrainingPlan(testUser.getCode(), MakeItFitDate.of(2024, 5, 1));

        trainingPlanCode = trainingPlan1.getCode();

        Running running = (new Running(testUser.getCode(),
                                       MakeItFitDate.of(2024, 5, 12),
                                       45,
                                       "Porto em Movimento",
                                       "Running",
                                       1000,
    ...
    void testExecuteQueryValidDates() {
        ...
        String result =
            trainingPlanAnalyzer.executeQuery(trainingPlanManager, userManager).toString();
    ...
    void testExecuteQueryInvalidInput() {
        ...
        assertThrows(NullPointerException.class,
                     () -> { trainingPlanAnalyzer.executeQuery(null, userManager); });
    }
}
