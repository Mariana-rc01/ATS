...
public class WhoBurnsMoreCaloriesTest {
    ...
    void setUp() {
        ...
        testUser1   = new Amateur("Test User 1",
                                30,
                                Gender.Male,
                                70,
                                180,
                                ...
                                "123456789",
                                "test1@example.com");
        testUser2   = new Amateur("Test User 2",
                                30,
                                Gender.Female,
                                60,
                                170,
        ...
        testUser1.addActivity(new Running(testUser1.getCode(),
                                          ...
                                          2300,
                                          14.5));
        testUser1.addActivity(new Trail(testUser1.getCode(),
        ...
        testUser2.addActivity(new Running(testUser2.getCode(),
