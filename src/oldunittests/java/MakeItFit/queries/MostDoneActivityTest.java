 ...
 *
 * This class contains tests for the constructors, methods, and operations of the MostDoneActivity
 * class,
 *
...
public class MostDoneActivityTest {
    ...
    void testExecuteQueryInvalidUser() {
        ...
        assertThrows(NullPointerException.class, () -> { activityAnalyzer.executeQuery(null); });
    }
}
